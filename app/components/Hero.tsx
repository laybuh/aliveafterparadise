...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            {/* image placeholder */}
            <div
                className="w-full max-w-[280px] md:max-w-[500px] h-[170px] md:h-[300px] mb-10 md:mb-16"
                style={{
                    background: "linear-gradient(135deg, #1a0505, #120818, #0a0a14)",
                    border: "1px solid #8E488D44",
                    boxShadow: "inset 1px 1px 0px #555555, inset -1px -1px 0px #000000, 4px 4px 0px #000000",
                }}
            />
